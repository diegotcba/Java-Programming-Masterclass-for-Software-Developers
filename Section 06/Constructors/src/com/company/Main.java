...
//        BankAccount account = new BankAccount(); //("12345", 0.00, "Bobby Brown", "noreply@bob.com", "1234-1234");
//
...
//        account.withdrawal(100.0);
//
        BankAccount timAccount = new BankAccount("Tim", "tim@email.com", "54 245234");
